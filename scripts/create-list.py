...
def main():
    ...
    # parser.add_argument("--items", default="../data/items.csv", type=os.path.realpath)
    # parser.add_argument("--locations", default="../data/locations.csv", type=os.path.realpath)
    # parser.add_argument("--types", default="../data/types.csv", type=os.path.realpath)
    ...
    items = pd.DataFrame(get_items(conn, args.show_all), columns=["quantity", "type", "name", "loc", "priority"])
